  ...
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 dark:text-white">
      <div class="flex gap-6 pt-4 flex-wrap">
        ...
        <a href="./instructors/view?id=<?= $instructor['id'] ?>" class="w-fit max-w-screen px-6 py-4 pt-6 bg-[#53796E] flex-wrap shrink-0  rounded-xl hover:-translate-y-3 transition duration-300 ease-in-out hover:underline">
