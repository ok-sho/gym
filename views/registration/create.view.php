    ...
    <form method="POST" action="">
      <div class="space-y-12">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
          <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-[#426158]">Sign Up</h2>
          <h3 class="mt-5 text-center text-2xl/9 tracking-tight text-[#426158]">Create a New Account</h3>
        </div>

        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <div>
            <label for="givenName" class="block text-sm/6 font-medium text-black">Given Name</label>
            <div class="mt-2">
          ...
          <div>
            <label for="familyName" class="block text-sm/6 font-medium text-black">Family Name</label>
            <div class="mt-2">
          ...
          <div>
            <label for="rePassword" class="block text-sm/6 font-medium text-black">Confirm Password</label>
            <div class="mt-2">
      ...
      <div class="mt-6 flex items-center justify-center gap-x-6">
        <button type="submit" class="rounded-md bg-[#426158] px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-[#426100] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign Up</button>
      </div>

      <p class="mt-5 text-center text-sm/6 text-black">
        Already have an account?  
        <a href="<?= BASE_URL ?>/login" class="font-semibold text-[#426158] hover:text-black">Log in</a>
      </p>
